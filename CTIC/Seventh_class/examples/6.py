...
class Window(Tk):
    def __init__(self):
        ...
        hello_button = Button(self, text = "Say Hello", command = self.say_hello) # Llamamos al m'etodo para cambiar la etiqueta
...
# No lleva parentesis en los metodos como argumentod